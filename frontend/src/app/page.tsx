...
const DEMO: DecisionListResponse = {
  ...
  decisions: [
    ...
    { task_id: "t-1029", case_id: "Research Best Practices", case_type: "Personal", agent_name: "Policy Scout", status: "review_required", risk_level: "medium", outcome: "escalated", outcome_summary: "Flagged for human review â€” recommendation conflicts with an existing policy reference.", duration_seconds: 95, human_review_status: "pending", created_at: "2026-08-12T11:00:00Z" },
  ...
  const onDrop = (col: string) => {
    ...
    setData((prev) => ({
      ...
      decisions: prev.decisions.map((d) =>
        d.task_id === dragId ? { ...d, status: col } : d
      ),
    }));
    setDragId(null);
    setDragOverCol(null);
